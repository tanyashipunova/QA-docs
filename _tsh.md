...
*Стек*<br>
ADB, API, JSON, XML, Python, SQL, Postman, DevTools, Docker, Swagger, PowerBI, Google Analytics

**Опыт работы**<br>
Тестировщик веб- и мобильных приложений | Фриланс | 01.2003 - ...
- Протестировала backend микросервисной архитектуры "Кредитный конвейер"
...
- Читаю документацию по API, сравниваю фактические и ожидаемые XML/JSON-ответы по HTTPs-запросам через Postman
